			...
			<?php $item_count=0; $total_price=0; $total_item_price=0;  if(@$cart['item']){ foreach ($cart['item'] as $key => $value_restaurant) {  $item_count++; ?>
				...
				<div class="bg-white p-3 clearfix btm-total">
					...
					<?php $discount_html = ""; $discount_amount=0; $coupon_id=''; $coupon_code=''; $discount=''; $discountType=''; if(@$cart['coupon'] && $cart['coupon']['discountType'] && $total_item_price > 0){ ?>
						...
						<p class="mb-1 text-success">
							...
							{{trans('lang.total')}} {{trans('lang.discount')}} <?php echo $discount_html; ?><span class="float-right text-success"><span class="currency-symbol-left"></span><?php echo $discount_amount; ?><span class="currency-symbol-right"></span></span>
						...
						if(@$cart['specialOfferDiscount'] && $total_item_price > 0){ ?>
							<p class="mb-1 text-success">
								...
								?>
								{{trans('lang.special')}} {{trans('lang.offer')}} {{trans('lang.discount')}} <?php echo $special_html;?><span class="float-right text-success"><span class="currency-symbol-left"></span><?php echo $specialOfferDiscount; ?><span class="currency-symbol-right"></span></span>
