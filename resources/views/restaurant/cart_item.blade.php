...
<div class="bg-white p-3 sidebar-item-list">
    ...
    <div class="product-item gold-members row align-items-center py-2 border mb-2 rounded-lg m-0"
        ...
        <div class="d-flex align-items-center count-number-box col-md-5">
											...
											<span class="count-number float-right">
												...
												<button type="button" data-vendor="<?php echo $key; ?>"
                                                        ...
                                                        class="count-number-input-cart btn-sm right inc btn btn-outline-secondary count_number_right"  data-vendor-id="<?php echo @$cart['restaurant']['id'] ?>">
        ...
        <div class="close remove_item col-md-1" data-restaurant="<?php echo $key; ?>" data-vendor-id="<?php echo @$cart['restaurant']['id'] ?>" data-id="<?php echo $key1; ?>"><i
...
<div class="bg-white px-3 clearfix">
    ...
    <div class="border-bottom pb-3">
        <div class="input-group-sm mb-2 input-group">
            ...
            <input placeholder="{{trans('lang.promo_help')}}" data-restaurant="<?php echo @$key1; ?>" data-vendor-id="<?php echo @$cart['restaurant']['id'] ?>"
