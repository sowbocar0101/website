                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <h6 class="font-weight-bold ml-auto mb-1" id="special_offer_discount"></h6>
        ...
        completedorsersref.get().then(async function (completedorderSnapshots) {
            ...
            if (orderDetails.author.id != user_uuid) {
				...
				if(orderDetails.address.name){
				    $("#billing_name").text(orderDetails.address.name);
				}else{
			   		$("#billing_name").text(orderDetails.author.firstName+' '+orderDetails.author.lastName);
			    }

                var billingAddressstring = '';
				if(orderDetails.address.hasOwnProperty('name')){
			      $("#billing_name").text(orderDetails.address.name);
			    }
