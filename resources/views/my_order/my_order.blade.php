        ...
        $(document).on("click", '.reorder-add-to-cart', function(event) { 
            ...
            $.ajax({
               ...
               data:{_token:'<?php echo csrf_token(); ?>',
                restaurant_id:restaurant_id,restaurant_location:restaurant_location,
                restaurant_name:restaurant_name,restaurant_image:restaurant_image,item:item,
                deliveryCharge:deliveryCharge,delivery_option:delivery_option,taxValue:taxSetting},
