                            ...
                            <div class="box-title m-b-20">{{ __('Login') }}</div>
                                ...
                                <div class="form-group text-center m-t-20">
                                    <div class="col-xs-12">
                                        ...
                                        <button type="button" onclick="loginBackClick()" class="btn btn-dark btn-lg btn-block text-uppercase waves-effect waves-light btn btn-primary"><i class="fa fa-envelope mr-2"> </i> {{ __('Login') }} {{trans('lang.with_email')}}</button>
